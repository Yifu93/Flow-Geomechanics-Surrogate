...
simulation_data = os.path.join(data_dir, 'Flow_Sw_Train.h5')
...
filePath = 'saved_models/saved-model-10steps-lr3e-4-saturation-detrend-hd-0-filter_16_32_32_64-mse-{epoch:03d}-{val_loss:.2f}.h5'
...
import pickle    
with open('HISTORY-saturation-mse-hd500-filter_8_16_32_32.pkl', 'wb') as file_pi:
